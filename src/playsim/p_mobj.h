...
typedef enum
{
    ...
    // Player cheat.
    // Disable collision detection for player.
    MF_NOCLIP = 0x1000,
    ...
    // Don't stop moving halfway off a step, that is,
    ...
    // internal color lookup table for re-indexing. If 0x4 0x8 or
    // 0xc, use a translation table for player colormaps
