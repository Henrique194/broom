...
// Supported protocols. If you're developing a fork of Broom, you can
// add your own entry to this list while maintaining compatibility with
// Chocolate Doom servers. Higher-numbered enum values will be preferred
// when negotiating a protocol for the client and server to use, so the
// order matters.
// NOTE: The values in this enum do not have any special value outside
