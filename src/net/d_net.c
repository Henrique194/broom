...
static void PlayerQuitGame(player_t *player) {
    ...
    // Do this the same way as Vanilla Doom does, to allow
    // dehacked replacements of this message
...
static void CheckPlayerQuits(bool *ingame) {
